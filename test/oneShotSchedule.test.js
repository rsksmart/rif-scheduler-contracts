...
contract('OneShotSchedule', (accounts) => {
  beforeEach(async () => {
    ...
    this.token = await ERC677.new(this.contractAdmin, toBN('1000000000000000000000'), 'RIFOS', 'RIF', toBN('18'))
  ...
  describe('payments', () => {
    ...
    it('should receive RIF tokens to purchase 1 scheduled -  ERC677 way', () => this.testERC677Purchase(0, 10, (plans[0].price).mul(toBN(10))))
